...
tail -n 2 /NAS1/lien/data/sorghum/Sorghum_bicolor.Sorghum_bicolor_NCBIv3.dna.10chr.fa > sorghum.chr10.v2.fa
head -n 6 /NAS1/lien/data/coix/BJCoxi_reference.V1.fa | tail -n 2 - > coix.chr3.v2.fa
